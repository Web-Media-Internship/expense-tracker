...
@section('container')
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <a href="#editwg" class="btn btn-warning btn-icon-split btn-sm ml-1" data-toggle="modal" 
            data-target="#">
                ...
                <form method="POST" action="/wallet/{{ $wlt->id }}">
                    ...
                    <div>
                        <input name="description" type="text" class="form-control form-control-user @error('description') is-invalid @enderror"
                            id="description" placeholder="description" value="{{ old('description', $wlt->description) }}">
                        @error('description')
                        <div class="text-danger ml-2">
                            <small>{{ $message }}</small>
                        </div>
